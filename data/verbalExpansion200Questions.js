...
const analogyFamilies = [
  ...
  ['measuring tool and what it measures', [['ruler', 'length'], ['scale', 'weight'], ['clock', 'time'], ['thermometer', 'temperature'], ['barometer', 'air pressure']]],
  ['part and the whole it belongs to', [['page', 'book'], ['wheel', 'car'], ['petal', 'flower'], ['branch', 'tree'], ['tile', 'floor']]],
